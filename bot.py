...
def send_force_join_msg(chat_id):
    ...
    for ch in bot_settings["fj_channels"]:
        ...
        kb.append([{"text": f"𝐌𝐚𝐢𝐧 𝐂𝐡𝐚𝐧𝐧𝐞𝐥", "icon_custom_emoji_id": "5789428375261023681", "url": url, "style": "primary"}])
...
def main_menu(user_id):
    kb = [
        [
            {"text": "𝐆𝐞𝐭 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5467539229468793355", "style": "primary"}, 
        ...
        [
            {"text": "𝐑𝐞𝐟𝐞𝐫", "icon_custom_emoji_id": "5420396762189831222", "style": "success"}, 
            {"text": "𝐖𝐢𝐭𝐡𝐝𝐫𝐚𝐰𝐚𝐥", "icon_custom_emoji_id": "5352585194295564660", "style": "danger"}
        ],
        [
            {"text": "𝐒𝐮𝐩𝐩𝐨𝐫𝐭", "icon_custom_emoji_id": "5420145051336485498", "style": "primary"}
        ]
    ]
    if is_admin(user_id): 
